...
**framePromotion** specifies the maximum number of times per second the plot will
...
(function($) {
    ...
    function initNevigation(plot, options) {
        ...
        function onDrag(e) {
            ...
            var page = browser.getPageXY(e);
            var framePromotion = plot.getOptions().pan.framePromotion;
            ...
            if (panTimeout || !framePromotion) return;
